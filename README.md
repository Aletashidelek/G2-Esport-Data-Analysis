...
6. Hans Sama, on the other hand, tends to choose champions that offer greater strategic value and CC. He is the team's top damage dealer, but thanks to the damage output ability from all of his teammates, he can afford to pick champions that are flexible and focus on strategic contributions as well. This dynamic allows G2 to maintain a well-rounded approach, making them a formidable force in any matchup.

     ![image](https://github.com/user-attachments/assets/d6ae29b8-8c06-4ad2-a7e4-06a4e00ea1c2)

7. G2 has a low win rate against certain champions, such as Nidalee and Ornn. While some of these picks are naturally advantageous in matchups and intended as counters, it's important to examine the overall composition and in-game performance of these matchups. For instance, Azir enjoys an average advantage in both CS and XP when facing Hwei across the LCS, LEC, and LCK. However, Caps' Azir experiences a notable drop in XP at the 15-minute mark when up against Hwei, primarily due to three consecutive losses in skirmishes between the 10 and 15-minute periods, as shown in the replay. Additionally, the heat maps indicate that Yone is a highly effective and dominant champion against both Hwei and Ornn.
